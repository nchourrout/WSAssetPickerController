Pod::Spec.new do|s|
    ...
    s.source={:git=>'https://github.com/nchourrout/WSAssetPickerController.git'}
    s.source_files='src/*.{h,m}'
    s.platform = :ios, 5.0
    s.framework = 'QuartzCore', 'AssetsLibrary', 'UIKit', 'CoreGraphics'
    s.requires_arc = true
    s.resources = 'demo/WSAssetViewSelectionIndicator.png','demo/WSAssetViewSelectionIndicator@2x.png', 'demo/WSAssetViewVideoIndicator.png', 'demo/WSAssetViewVideoIndicator@2x.png'
